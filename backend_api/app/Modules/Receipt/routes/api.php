...
Route::group(['prefix' => 'v2/receipt'], function () {
    Route::group(['middleware' => ['auth:sanctum']], function () {
        Route::get('get-receipt-for-invoice/{invoice}', \App\Modules\Receipt\Controllers\GetReceiptForInvoiceController::class);
    });
    Route::get('get-receipt-for-stead/{stead}', \App\Modules\Receipt\Controllers\GetReceiptForSteadController::class);
