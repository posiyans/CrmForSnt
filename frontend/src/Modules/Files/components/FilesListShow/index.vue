<template>
  <div>
    <div class="row items-center">
      ...
      <q-space v-if="filtersList.length > 0" />
    ...
    <q-separator v-if="filtersList.length > 0" />
    <div v-if="filtersList.length > 0">
      <ListView v-if="viewFormat === 'list'" :edit="edit" :get-url="getUrl" :files="filtersList" />
      <SmallView v-if="viewFormat === 'small'" :edit="edit" :get-url="getUrl" :files="filtersList" />
      <ImageView v-if="viewFormat === 'image'" :edit="edit" :get-url="getUrl" :files="filtersList" />
    </div>
  </div>
</template>
