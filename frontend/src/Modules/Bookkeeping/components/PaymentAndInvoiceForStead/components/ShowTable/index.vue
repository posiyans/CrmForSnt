        ...
        <q-tr :props="props" :class="{ 'balance-red': props.row.type.uid === 'invoice',  'balance-green': props.row.type.uid === 'payment' }" :style="props.row.is_paid ?  'opacity: .5': ''">
          ...
          <q-td>
            ...
            <div class="row items-center no-wrap">
              ...
              <q-space class="sm-hide xs-hide" />
              <div v-if="props.row.type.uid === 'payment' && props.row.rate.depends === 2" class="sm-hide xs-hide">
                <ShowReadingListInPayment :payment="props.row" />
              </div>
              <InvoicePaymentsBlock v-if="props.row.type.uid === 'invoice'" :invoice="props.row" class="sm-hide xs-hide" />
            </div>
          </q-td>
...
import InvoicePaymentsBlock from './components/InvoicePaymentsBlock/index.vue'
