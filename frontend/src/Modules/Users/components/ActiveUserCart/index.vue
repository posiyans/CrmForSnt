    ...
    <div class="row items-center">
      <div>
        <div class="row items-center q-col-gutter-sm">
          ...
          <div class="text-weight-bold text-primary text-big-50">
            <div>
    ...
    <div>
      ...
      <q-tab-panels v-model="data" animated>
        ...
        <q-tab-panel name="ban">
          <BanUserInfo :user-uid="activeUserStore.userUid" />
        </q-tab-panel>

        <q-tab-panel name="comments">
          <CommentsList v-if="activeUserStore.user.uid" :user-uid="activeUserStore.userUid" />
        </q-tab-panel>
        <q-tab-panel name="appeal" class="">
          <AppealList
            v-if="activeUserStore.user.uid"
            :user-uid="activeUserStore.userUid"
          />
        </q-tab-panel>
